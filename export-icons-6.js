...
const DEFAULT_CONFIG = {
    ...
    fileNaming: {
        ...
        extension: "svg", // Extensión de archivo
...
if (process.argv[1] && import.meta.url.endsWith(process.argv[1].replace(/\\/g, '/'))) {
    ...
    const customConfig = {
        ...
        outputDir: "./icons/iconify", // Cambiar directorio de salida
        defaultSize: 64, // Cambiar tamaño por defecto
        defaultColor: "#22918b", // Cambiar color por defecto
        iconsToExport: [], // Exportar todos los iconos
        // Nuevas opciones de naming y organización
        fileNaming: {
            pattern: "{icon}-{size}", // Patrón: {collection}, {icon}, {size}, {color} 
            case: "snake" // "kebab", "camel", "pascal", "snake", "original"
        },
        folderStructure: {
            enabled: true, // Si false, todos los archivos van a outputDir directamente
            pattern: "{collection}", // Patrón: {collection}, {collection}/{size}, custom path
            groupBySize: true, // Crear subcarpetas por tamaño
            groupByColor: false // Crear subcarpetas por color
        }
    };
